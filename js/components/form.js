    ...
    mainContent.innerHTML = `
        ...
        <form id="userProfileForm" method="POST">
            <div class="form-group row">
                ...
                <input type="text" class="form-control col-md-4" required id="UPFirstName" placeholder="Enter first name">
                
            </div>
            <div class="form-group row">
                <label class="col-md-4 col-form-label">Middle name</label>
                    <input type="text" class="form-control col-md-4" id="UPMiddleInitial" placeholder="Enter middle name">
            </div>
            <div class="form-group row">
                <label class="col-md-4 col-form-label">Last name <span class="required">*</span></label>
                <input type="text" class="form-control col-md-4" required id="UPLastName" placeholder="Enter last name">
