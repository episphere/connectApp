        ...
        if(data['919254129'] === 353358909){
            ...
            if(data['699625233'] && data['699625233'] === 353358909){
                ...
                if (data.hasOwnProperty('831041022') && data['831041022'] == 353358909){
                    ...
                    else if((data['747006172'] && data['747006172'] !== 104430631) && (!data['359404406'] || data['359404406'] == 104430631)){
                        finalMessage += "You have a new <a href='#agreements'>form</a> to sign.<br>You have been withdrawn from Connect per your request.<br>"
                    }
                    else{
                ...
                else if (((data.hasOwnProperty('773707518') && data['773707518'] == 353358909) || (data['747006172'] && data['747006172'] == 353358909)) && (!data['359404406'] || data['359404406'] == 104430631)){
