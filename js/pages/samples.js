...
const marshfield = {
    ...
    scheduling: 'For questions and scheduling please call: 715-898-9444 or email connectstudy@marshfieldresearch.org.<br><br>All patients and visitors are required to wear a mask. If you enter the building without a mask, we will give one to you. If you are unable to wear a mask for the duration of the visit, we ask that you do not schedule your visit at this time.',
...
const henry_ford = {
    ...
    scheduling: 'For questions and scheduling please call 855-574-7540 or email ConnectStudy@hfhs.org.<br><br><em>All patients and visitors are required to wear a mask. If you enter the building without a mask, we will give one to you. If you are unable to wear a mask for the duration of the visit, we ask that you do not schedule your visit at this time.</em>',
