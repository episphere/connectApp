...
const marshfield = {
    ...
    locations: [
        ...
        [
            ...
            'Monday, Tuesday, Thursday: 8:00 a.m. - 2:00 p.m.<br> Wednesday: 7:00 a.m. - 2:00 p.m.',
            'General parking available'
        ],
        [
            'Weston Center',
            '3400 Ministry Pkwy<br>Weston, WI 54476',
            'Mondays and Thursdays: 8:00 a.m. to 1:00 p.m. *please ask about evening and Friday appointment availability if needed',
            'General parking available'
        ],
        [
