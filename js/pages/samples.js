...
const henry_ford = {
    ...
    whenToDonate: 'The Connect team will send you an email when it is time to donate your samples. Be sure to check your spam or junk folder. After you receive the email, it is important to donate your samples as soon as you can.<br><br><span id="bld">Important Notes:</span><br><br><ol><li> If you have had a blood transfusion or donated blood recently:<br> Please wait at least <span id="bld">eight weeks</span> from your donation or transfusion before donating your samples for Connect.</li><br><li> If you have recently donated plasma:<br> Please wait at least <span id="bld">two days</span> from your plasma donation before donating samples for Connect.</li><br><li> If you have an upcoming colonoscopy:<br> Please be sure that you <span id="bld">do not</span> donate samples for Connect on the <span id="bld">same day</span> as your colonoscopy.</li></ol>',
    howToDonate: 'Connect participants at Henry Ford Health have two options for donating samples. You can choose the most convenient option for you.<br><br><span id="bld">Option 1:</span> Make an appointment to come into one of our Connect Research Labs to donate your samples.<br><br><span id="bld">Option 2:</span> A study team member can request a lab order be placed for you. After you receive the order confirmation email, you can donate samples by visiting a participating Henry Ford Health Lab Services location during normal hours of operation.<br><br> The table below includes more information about these options.<br><br><table border="1"><tr><th><span id="bld">Option 1: Connect Research Lab</span> </th><th><span id="bld">Option 2: HFH Lab Services</span></th></tr><tr><td>Connect team will greet you and walk you through your visit.</td><td>More hours and more locations, no need to schedule an appointment.</td></tr><tr><td>The team will draw blood, collect urine, and collect a saliva sample by asking you to swish with mouthwash.</td><td>Lab staff will collect blood and urine samples at your visit. We will send a mouthwash collection kit and instructions to you to complete your saliva sample at home.</td></tr><tr><td>Schedule your appointment using the link in the email we send or schedule with Connect staff by calling 855-574-7540.</td><td>Request a lab order using the link in the email we send. The order will be placed by Connect staff.<span id="bld"> Please allow up to 48 hours to receive order confirmation via email.</span> Once you receive the confirmation email, visit a participating HFH Lab Services location.<span id="bld"> Orders expire after 90 days.</span></td></tr></table><br>When it is time to donate your samples, we will send you an email with a link to make your selection. Simply click the link to schedule a time that works for you to donate your samples at a Connect Research Lab or to request a lab order be placed so you can donate samples at a participating Henry Ford Health Lab Services location. <br><br> You can donate Connect samples and complete any labs ordered by your provider in the same visit.<br><br><span id="bld">For questions or assistance with transportation, please call 855-574-7540 or email <a href="mailto:ConnectStudy@hfhs.org">ConnectStudy@hfhs.org</a></span>',
    howLong: '<span id="bld">For Option 1: Connect Research Lab Appointment</span><br>Please expect to spend about one hour at your appointment to donate your samples and complete a short survey.<br><br><span id="bld">For Option 2: Henry Ford Health Lab Services Locations</span><br>Wait times to donate samples may vary by location. To better serve HFH patients, Henry Ford Lab Services have started using <span id="bld">“Save My Spot".</span><br><br><span id="bld">“Save My Spot"</span> is an optional service to reserve your spot in line at one of the participating Henry Ford Health Lab Services locations (Macomb and Wyandotte). All lab orders must be placed before using “Save My Spot,” including your lab order for Connect.<br><br>To use this optional service, click this link only after receiving order confirmation from Connect staff: <a href= "https://www.henryford.com/locations/henry-ford-hospital/lab-services">https://www.henryford.com/locations/henry-ford-hospital/lab-services</a> ',
    prepareInstructions: 'On the day of your visit to donate samples for Connect, you do not need to fast unless told to do so by your provider for any other lab work they’ve ordered. We request you drink plenty of water to keep hydrated but <span id="bld">stop drinking water one hour before your visit.</span><br><br><span id="bld">One hour before your visit:</span> Please <span style=span id="bld">do not</span> eat, drink, chew gum, smoke, vape, or chew any products (including tobacco), rinse your mouth, or brush your teeth.<br><br><span id="bld">Things to bring and remember:</span> We will ask you to complete a short survey on MyConnect after you donate samples. You will need your login method for MyConnect and a personal device to complete the survey. <br><br>You will be asked questions related to:<ul><li>The last time you ate or drank before your appointment, and the time you went to sleep the night before your appointment and woke up on the day of your appointment.</li><li>If you are menstruating, the start date of your most recent menstrual period in the last 12 months.</li></ul><br><div class="consentHeadersFont" style="color:#606060;width:100%">When Will I Receive My $25 Payment?</div><br>You will receive your $25 gift card after you donate a blood sample and complete <span id="bld">all four sections</span> of your first Connect survey.<br><br>You can find the four sections of your first survey on your MyConnect Dashboard. These sections are:<ol><li>Background and Overall Health</li><li>Medications, Reproductive Health, Exercise, and Sleep</li><li>Smoking, Alcohol, and Sun Exposure</li><li>Where you Live and Work</li>',
