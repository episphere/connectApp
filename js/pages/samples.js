...
const marshfield = {
    ...
    locations: [
        [
            ...
            'Monday - Friday: 8:00 a.m.-2:00 p.m. *please ask about early morning or evening appointment availability if needed',
            'General parking available'
        ],
        [
            'Lake Hallie Center',
            '12961 27th Ave<br>Chippewa Falls, WI 54729',
            'Monday - Friday: 10:00 a.m.-2:00 p.m. *please ask about early morning or evening appointment availability if needed',
            'General parking available'
        ],
        [
            'Weston Center',
            '3400 Ministry Pkwy<br>Weston, WI 54476',
            'Monday - Friday: 8:00 a.m. to 2:00 p.m. *please ask about early morning or evening appointment availability if needed',
            'General parking available'
        ]
    ]
};
...
const henry_ford = {
    ...
    locations: [
        [
            ...
            'Tuesday and Thursday 9:00 a.m. – 3:30 p.m. Wednesday 9:30a.m-3:30p.m.',
        ...
        [
            ...
            'Mondays ,Tuesdays and Wednesdays 9:00 a.m. to 4:00 p.m.',
            'Easy, free self-parking is available in the surface lot in front of the building. From the service drive, turn into the lot near the Aldi and head towards the back of the plaza. The medical center, and parking lot, are located behind Aldi.<br><br><h4>Option 2: Henry Ford Health Lab Services locations</h4>',
        ],
        [
