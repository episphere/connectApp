    ...
    <div class="row d-md-none" style="margin-top:-50px; padding-bottom:0px">
        ...
        <div class="col-lg-10">
            <div class="row" style"padding-bottom:0px;padding-top:0px;">
                ...
                <p class="consentBodyFont2" style="margin-left:4px; color:#2A72A5;"> of 8 <b style="color:#2E2E2E; font-family: 'Noto Sans', sans-serif; font-weight:bold;">${progress > 7?'':list[progress-1]}</b></p> 
            </div>
        </div>
        <div class="col-lg-1">
        </div>
