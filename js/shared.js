...
export const questionnaireModules = () => {
    if(location.host == urls.prod){
        ...
        return {
            ...
            'Clinical Biospecimen Survey': {url: 'https://raw.githubusercontent.com/episphere/questionnaire/main/mockSurvey.txt', moduleId:"ClinicalBiospecimen", enabled:false},
