...
export const questionnaireModules = () => {
    if(location.host == urls.prod){
        ...
        return {
            ...
            'Smoking, Alcohol, and Sun Exposure': {url: 'https://raw.githubusercontent.com/episphere/questionnaire/main/moduleBio.txt', moduleId:"Module3", enabled:true},
            'Where You Live and Work': {url: 'https://raw.githubusercontent.com/episphere/questionnaire/main/moduleBio.txt', moduleId:"Module4", enabled:true},
            'Enter SSN': {url: 'https://raw.githubusercontent.com/episphere/questionnaire/main/ssnModule.txt', moduleId:"ModuleSsn", enabled:false},
